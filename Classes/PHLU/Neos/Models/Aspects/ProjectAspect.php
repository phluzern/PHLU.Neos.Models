...
class ProjectAspect
{
    ...
    public function updateProjectNode(NodeData $node, Project $project)
    {
        ...
        // dont'index $node->setProperty('abstracttextgerman', $project->getAbstractTextGerman());
        // dont'index $node->setProperty('abstracttextenglish', $project->getAbstractTextEnglish());
        ...
        // dont'index $node->setProperty('photos', $project->getPhotos());
        // dont'index $node->setProperty('documents', $project->getDocuments());
        // dont'index $node->setProperty('links', $project->getLinks());
        // dont'index $node->setProperty('participants', $project->getParticipants());
